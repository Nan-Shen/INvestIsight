...
class InvestCrew:
    ...
    def write_topic(self) -> Task:
        return Task(
            ...
            async_execution=False,
            context=[self.research_topic()] #fix AttributeError: 'function' object has no attribute 'get'https://community.crewai.com/t/attribute-error-str-object-has-no-attribute-get/1079/16
        )
